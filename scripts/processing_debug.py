...
# Configurações
nome_do_ficheiro = "chair.ply" 
nome_saida_stl = "chair_mesh.stl"
...
# =========================================================================
# VISUALIZAÇÃO 1: NUVEM INICIAL
# =========================================================================
print(f"-> Nuvem original: {len(pcd.points)} pontos.")
print("\n[A AGUARDAR] A abrir a visualização da NUVEM INICIAL...")
print("             (Fecha a janela 3D para o script avançar para a filtragem)")
o3d.visualization.draw_geometries([pcd], window_name="1. Nuvem Inicial (Raw)")


# =========================================================================
# FASE 1 & 2: FILTRAGEM 
# =========================================================================
print("\nA aplicar limpeza de ruído e voxel downsampling...")
# Limpeza de ruído
...
# =========================================================================
# VISUALIZAÇÃO 2: NUVEM FILTRADA E PROCESSADA
# =========================================================================
print(f"-> Nuvem processada: {len(pcd_limpo.points)} pontos.")
print("\n[A AGUARDAR] A abrir a visualização da NUVEM FILTRADA...")
print("             (Fecha a janela 3D para o script avançar para a geração da Mesh)")
o3d.visualization.draw_geometries([pcd_limpo], window_name="2. Nuvem Filtrada (Limpa)")
...
if not mesh_final.is_empty():
    ...
    # 3. APLICAR ROTAÇÃO DE 180º NO EIXO X (Red)
    # Rotação sobre a origem (0,0,0)
    #R = mesh_final.get_rotation_matrix_from_xyz((np.pi, 0, 0))
    #mesh_final.rotate(R, center=(0, 0, 0))

    # Visualização para conferir antes de salvar
    print("\n[A AGUARDAR] A mostrar Mesh final...")
    print("             (Fecha a janela 3D para gravar o ficheiro)")
    o3d.visualization.draw_geometries([mesh_final], window_name="3. Mesh Final (.stl)", mesh_show_back_face=True)
